...
/// Default App Button
class DxButtonBorder extends StatefulWidget {
  ...
  @override
  DxButtonBorderState createState() => DxButtonBorderState();
}

class DxButtonBorderState extends State<DxButtonBorder>
        ...
        child: MaterialButton(
          ...
          onPressed: widget.enabled
              ? widget.onTap != null
                  ...
                  : null
              : null,
          color: widget.color ?? appBorderButtonBackgroundColorGlobal,
          shape: widget.shapeBorder ?? defaultBorderButtonShapeBorder,
          ...
          child: widget.child ??
              Text(
                ...
                style: widget.textStyle ??
                    boldTextStyle(
                      color: widget.textColor ?? textPrimaryColorGlobal,
                    ),
              ),
        ),
      ),
