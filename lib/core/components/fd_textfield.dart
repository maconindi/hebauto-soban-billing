...
import '../util/ext/double.dart';
import '../util/ext/int.dart';
...
class FDTextField extends StatefulWidget {
  ...
  @override
  FDTextFieldState createState() => FDTextFieldState();
}

class FDTextFieldState extends State<FDTextField> {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: widget.decoration != null
            ...
            : InputDecoration(hintText: widget.hint, helperText: ' '),
