...
const textPrimaryColor = Color(0xFFF14E62);
const textSecondaryColor = Color(0xFFFFFFFF);
const textTertiaryColor = Color(0xFF000000);
const buttonSecondaryColor =  Color(0xFF273242);
