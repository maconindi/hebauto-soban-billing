...
part of 'fetch_report_state.dart';
...
mixin _$ReportState {
  ...
  List<ReportItemEntity> get data => throw _privateConstructorUsedError;
  Type? get view => throw _privateConstructorUsedError;
...
class _$ReportStateImpl implements _ReportState {
  _$ReportStateImpl(
      ...
      this.currentPage = 0,
      this.lastPage = 0,
      final List<ReportItemEntity> data = const <ReportItemEntity>[],
      this.view,
  ...
  @JsonKey()
  final int lastPage;
  final List<ReportItemEntity> _data;
  @override
  @JsonKey()
  List<ReportItemEntity> get data {
  ...
  @override
  String toString() {
    return 'ReportState(success: $success, message: $message, inventId: $inventId, prePageUrl: $prePageUrl, nextPageUrl: $nextPageUrl, firstPageUrl: $firstPageUrl, lastPageUrl: $lastPageUrl, currentPage: $currentPage, lastPage: $lastPage, data: $data, view: $view, status: $status)';
  }
...
abstract class _ReportState implements ReportState {
  factory _ReportState(
      ...
      final int currentPage,
      final int lastPage,
      final List<ReportItemEntity> data,
      final Type? view,
      final DashboardStatus status}) = _$ReportStateImpl;
