...
part 'filter_report_usecase.freezed.dart';
part 'filter_report_usecase.g.dart';

@lazySingleton
class FilterReportUseCase extends UseCase<ReportEntity, FilterReportParams> {
  final ReportRepository repository;

  FilterReportUseCase(this.repository);

  @override
  Future<Either<Failure, ReportEntity>> call(FilterReportParams params) =>
      repository.filterReport(params);
}

@freezed
class FilterReportParams with _$FilterReportParams {
  const factory FilterReportParams({
    @JsonKey(name: 'carStatus') @Default('') String carStatus,
    @JsonKey(name: 'paymentStatus') @Default('') String paymentStatus,
    @JsonKey(name: 'customerName') @Default('') String customerName,
    @JsonKey(name: 'startDate') @Default('') String startDate,
    @JsonKey(name: 'endDate') @Default('') String endDate,
  }) = _FilterReportParams;

  factory FilterReportParams.fromJson(Map<String, dynamic> json) =>
      _$FilterReportParamsFromJson(json);
}
