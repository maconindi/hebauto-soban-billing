...
_$TowingParamsImpl _$$TowingParamsImplFromJson(Map<String, dynamic> json) =>
    _$TowingParamsImpl(
      ...
      deliveryDate: json['warehouse_delivery_date'] == null
          ? null
          : DateTime.parse(json['warehouse_delivery_date'] as String),
...
Map<String, dynamic> _$$TowingParamsImplToJson(_$TowingParamsImpl instance) =>
    <String, dynamic>{
      ...
      'warehouse_delivery_date': instance.deliveryDate?.toIso8601String(),
