...
import 'package:hebauto/features_admin/inventory/domain/repository/inventory_repository.dart';
...
@injectable
class InventoryUseCase extends UseCase<InventoryEntity, InventoryParams> {
  final InventoryRepository repository;

  InventoryUseCase(this.repository);

  @override
  Future<Either<Failure, InventoryEntity>> call(InventoryParams params) =>
      repository.addInventory(params);
}


@freezed
class UploadDataParams with _$UploadDataParams {

  const factory UploadDataParams({
  ...
  // factory UploadDataParams.fromJson(Map<String, dynamic> json) =>
  //     _$UploadDataParamsFromJson(json);
...
class InvoiceParams with _$InvoiceParams {
  const factory InvoiceParams({
    ...
    @JsonKey(name: 'invoice_amount_cad') @Default('N/A') String invoiceAmountCad,
    @JsonKey(name: 'hst_amount_cad') @Default('N/A') String hstAmountCad,
    @JsonKey(name: 'invoice_amount_aed') @Default('N/A') String invoiceAmountAed,
